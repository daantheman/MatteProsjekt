...
\\
Da vi fikk rettet opp i problemet gikk resten ganske smertefritt.
\\
ebbeam.m
\\
...
\end{lstlisting}
Vi vet fra teorien at kondisjonstallet til A er den maksimale feilforstørrelsen man kan oppnå. Med et kondisjonstall på $10^4$ kan man forvente $16-4=12$ korrekte desimaler i svaret. Feilforstørrelsen er mye mindre enn kondisjonstallet. Hadde feilforstørrelsen vært lik kondisjonstallet hadde det vært værste utfall. Vi kan kunkludere med at har en grei feilforstørrelse.
...
\end{lstlisting}
Vi ser at denne foroverfeilen er i samme størrelsesorden som $\epsilon_{mach}$, vi tenker at dette er fordi datamaskinen får avrundingsfeil på grunn av avrunning ved flyttall. Denne feilen er på ca på $\epsilon_{mach}$, så det at feilestimatet ligger i nærheten er å forvente.
